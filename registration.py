...
class Graph:
    ...
    def compute_depth(self):
        ...
        def dfs(vertex_index):
            ...
            adjacent_vertices = self.get_adjacent_vertices(vertex_index)

            max_depth = 0
            for adj in adjacent_vertices:
                max_depth = max(max_depth, dfs(adj) + 1)

            self.vertices[vertex_index].depth = max_depth
            return self.vertices[vertex_index].depth

        for i in range(len(self.vertices)):
            self.vertices[i].depth = -1
    ...
    def has_cycle(self):
        ...
        def dfs(vertex):
            ...
            for neighbor in range(len(self.adjacency_matrix[vertex])):
